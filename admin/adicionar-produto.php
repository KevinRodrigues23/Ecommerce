...
if($_SERVER['REQUEST_METHOD'] === 'POST')
{
  ...
  $produto->adicionar($_POST["titulo_produto"],$_POST["preco_produto"],$_POST["tamanho_produto"],$_POST["marcar_produto"]
              ...
              <div class="col-md-6 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    ...
                    <form action="adicionar-produto.php" method="POST" class="forms-sample" enctype="multiple/form-data">

                    <div class="form-group">
                    <div class="form-group d-flex justify-content-around p-1">
                    <img src="" class="rounded text-center" alt="...">
                    ...
                    <div class="form-group mt-2">
                        ...
                        <input type="file" name="imagem_produto" multiple="multiple" class="file-upload-default">
                      ...
                      <div class="form-group">
                        ...
                        <input type="text" name="titulo_produto" class="form-control" id="exampleInputUsername1" placeholder="Nome do produto">
                      </div>
                      <div class="form-group">
                        <label for="exampleInputUsername1">preco do produto</label>
                          <div class="input-group">
                            <div class="input-group-prepend">
                              ...
                              <input type="text" name="preco_produto" class="form-control">
                            </div>
                      ...
                      <div class="form-group">
                        ...
                        <input type="text" name="tamanho_produto" class="form-control" id="exampleInputPassword1" placeholder="Tamanho do produto ">
                      </div>

                      <div class="form-group">
                        <label for="exampleInputConfirmPassword1">Marcar do produto</label>
                        <input type="text" name="marcar_produto" class="form-control" id="exampleInputConfirmPassword1" placeholder="Marcar do produto">
                      </div>
                      <div class="form-group">
                        <label for="exampleInputConfirmPassword1">cor do produto</label>
                        <input type="text" name="cor_produto" class="form-control" id="exampleInputConfirmPassword1" placeholder="Cor do produto">
                      </div>

                      <div class="form-group">
                        <label for="exampleInput">Quantidade dos produtos</label>
                        <input type="text" name="quantidade_produto" class="form-control"  placeholder="Quantidade"></input>
                      </div>
