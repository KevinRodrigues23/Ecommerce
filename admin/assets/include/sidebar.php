...
<nav class="sidebar sidebar-offcanvas" id="sidebar">
        <div class="sidebar-brand-wrapper d-none d-lg-flex align-items-center justify-content-center fixed-top">
          <a class="sidebar-brand brand-logo" href="index.php"><img src="" value="CyberAmerican" alt="CyberAmerican" /></a>
        ...
        <ul class="nav">
            ...
            <div class="profile-desc">
              <div class="profile-pic">
                ...
                <div class="profile-name">
                  <h5 class="mb-0 font-weight-normal">Kenix</h5>
          ...
          <li class="nav-item menu-items">
            <a class="nav-link" href="pages/basic-table.php">
              ...
              <span class="menu-title">todas as Mensagem</span>
            </a>
          </li>
          <li class="nav-item menu-items">
            <a class="nav-link" href="pages/chartjs.php">
              <span class="menu-icon">
          ...
          <li class="nav-item menu-items">
            <a class="nav-link" href="pages/mdi.php">
              <span class="menu-icon">
