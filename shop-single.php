...
$produto = $obj_produto->encontrarPorId($_GET['id']);
?>
        ...
        <div class="container pb-5">
            <div class="row">
                ...
                <div class="col-lg-7 mt-5">
                    <div class="card">
                        <div class="card-body">
                            <h1 class="h2"><b><?php echo $produto['titulo_produto'];?></b></h1>
                            <p class="h3 py-2"><span>R$: </span><?php echo $produto['preco_produto'];?><span>,00</span></p>
                            <p class="py-2">
                            ...
                            <ul class="list-inline">
                                ...
                                <li class="list-inline-item">
                                    <p class="text-muted"><strong><?php echo $produto['marcar_produto'];?></strong></p>
                                </li>
                            </ul>
                            ...
                            <ul class="list-inline">
                                <li class="list-inline-item">
                                    <h6>Cor disponível :</h6>
                                </li>
                                <li class="list-inline-item">
                                    <p class="text-muted"><strong><?php echo $produto['cor_produto'];?></strong></p>
                                </li>
                            </ul>

                            <h6>Specification:</h6>
                            <ul class="list-unstyled pb-3">
                                <li><?php echo $produto['especificacao_produto'];?></li>
                            </ul>
                            ...
                            <form action="" method="GET">
                                ...
                                <div class="row">
                                    <div class="col-auto">
                                        <ul class="list-inline pb-3">
                                            <li class="list-inline-item">tamanho :
                                ...
                                <div class="row pb-3">
                                    <div class="col d-grid">
                                        <button type="submit" class="btn btn-success btn-lg" name="submit" value="Comprar">Comprar</button>
                                    </div>
                                    <div class="col d-grid">
                                        <button type="submit" class="btn btn-success btn-lg " name="submit" value="addtocard">
                                            <?php echo'
                                        <b><a class="nav-link text-white" href="assets/includes/carrinho.php?add=carrinho&id='.$produto['id_produto'].'">adicionar Carrinho</a></b>'; ?>
